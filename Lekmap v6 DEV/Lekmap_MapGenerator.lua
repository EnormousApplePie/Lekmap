------------------------------------------------------------------------------
--	FILE:    Lekmap_MapGenerator.lua  (renamed from HBMapGenerator.lua)
--	AUTHORS: Shaun Seckman, Bob Thomas
--	PURPOSE: Base logic for map generation.
--           Includes all Lekmap modules (replaces HBAssignStartingPlots).
------------------------------------------------------------------------------
--	Copyright (c) 2010 Firaxis Games, Inc. All rights reserved.
------------------------------------------------------------------------------

-- Lekmap modular system (replaces the monolithic HBAssignStartingPlots).
...
function StartPlotSystem()
	-- Default start plot system using Lekmap modules.
	-- Map scripts should override this function with their own (see LekmapPangaeaFractalv6.lua).
